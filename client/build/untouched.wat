(module
 ...
 (data (i32.const 360) "$\00\00\00\01\00\00\00\01\00\00\00$\00\00\00K\00e\00y\00 \00d\00o\00e\00s\00 \00n\00o\00t\00 \00e\00x\00i\00s\00t\00")
 (data (i32.const 416) "\16\00\00\00\01\00\00\00\01\00\00\00\16\00\00\00~\00l\00i\00b\00/\00m\00a\00p\00.\00t\00s\00")
 (data (i32.const 456) "\04\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\18\0d\1a\00\00\00\00\00")
 (table $0 1 funcref)
 ...
 (global $assembly/index/memory (mut i32) (i32.const 0))
 (global $~lib/rt/__rtti_base i32 (i32.const 456))
 (global $~lib/heap/__heap_base i32 (i32.const 492))
 ...
 (func $~lib/map/Map<f64,f64>#clear (; 29 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  local.tee $1
 ...
 (func $~lib/map/Map<f64,f64>#constructor (; 30 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 24
 ...
 (func $start:assembly/index (; 31 ;) (type $FUNCSIG$v)
  ...
  global.set $assembly/index/memory
 )
 (func $~lib/util/hash/hash64 (; 32 ;) (type $FUNCSIG$ij) (param $0 i64) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
 ...
 (func $~lib/map/Map<f64,f64>#find (; 33 ;) (type $FUNCSIG$iidi) (param $0 i32) (param $1 f64) (param $2 i32) (result i32)
  (local $3 i32)
  local.get $0
  i32.load
  local.get $2
 ...
 (func $~lib/map/Map<f64,f64>#has (; 34 ;) (type $FUNCSIG$iid) (param $0 i32) (param $1 f64) (result i32)
  (local $2 f64)
  local.get $0
  local.get $1
 ...
 (func $assembly/index/_fib (; 35 ;) (type $FUNCSIG$dd) (param $0 f64) (result f64)
  local.get $0
  f64.const 1
  f64.le
  if
 ...
 (func $~lib/map/Map<f64,f64>#rehash (; 36 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/map/Map<f64,f64>#set (; 37 ;) (type $FUNCSIG$vidd) (param $0 i32) (param $1 f64) (param $2 f64)
  (local $3 f64)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $~lib/map/Map<f64,f64>#get (; 38 ;) (type $FUNCSIG$did) (param $0 i32) (param $1 f64) (result f64)
  (local $2 f64)
  (local $3 i32)
  local.get $0
  local.get $1
 ...
 (func $assembly/index/fib (; 39 ;) (type $FUNCSIG$dd) (param $0 f64) (result f64)
  global.get $assembly/index/memory
  local.get $0
  call $~lib/map/Map<f64,f64>#has
  if
   local.get $0
   return
  end
 ...
 (func $~lib/map/Map<f64,f64>#__visit_impl (; 42 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
  local.get $1
